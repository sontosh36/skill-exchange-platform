  ...
  return (
    <div className="bg-gray-200 p-3 rounded text-center shadow-sm space-y-2 object-fill">
      ...
      <div className="flex justify-between">
        <p className="bg-green-200 p-2 rounded-xl text-sm text-blue-900">Rating: {rating}</p>
        <p className="bg-green-200 p-2 rounded-xl text-sm text-blue-900">Price: ${price}</p>
      </div>
